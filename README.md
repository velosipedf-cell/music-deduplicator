...
```
┌──────────────────────────────────────────────────────┐
│ Folder: [D:\Music\________________] [Browse…]        │
│                                                      │
│ Scan mode                                            │
│ ○ Tags only                                          │
│ ○ Acoustic                                           │
│ ● Hybrid — tags + acoustic verification (recommended)│
│                                                      │
│ [▶ Scan]  [Cancel]                                   │
│ ████████████░░░░░░░░░░  Scanning: 42/200 — song.mp3  │
│                                                      │
│ ┌─ [TAGS+♪]  Artist  —  Song Title ──────────────┐  │
│ │ ★ BEST  song_320.mp3  (320 kbps)               │  │
│ │ ─────────────────────────────────────────────── │  │
│ │ ☑ song_128.mp3  (128 kbps)  4.2 MB             │  │
│ │ ☑ song_copy.mp3  (192 kbps)  5.1 MB  match:95% │  │
│ └─────────────────────────────────────────────────┘  │
│                                                      │
│ ☑ Select all    ○ Delete  ● Move to _duplicates     │
│ Groups: 2 | Duplicates: 3 | ~15.2 MB     [Execute]   │
└──────────────────────────────────────────────────────┘
```
...
```bash
git clone https://github.com/Akula2012/music-deduplicator.git
